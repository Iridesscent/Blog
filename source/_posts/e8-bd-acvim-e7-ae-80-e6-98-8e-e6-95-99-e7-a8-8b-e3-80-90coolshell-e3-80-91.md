---
title: '[转]Vim简明教程【CoolShell】'
id: 253
categories:
  - Linux
date: 2016-06-19 20:50:33
tags:
  - Vim
---
...
#### <a name="t6"></a>第四级 – Vim 超能力

你只需要掌握前面的命令，你就可以很舒服的使用VIM了。但是，现在，我们向你介绍的是VIM杀手级的功能。下面这些功能是我只用vim的原因。

##### <a name="t7"></a>在当前行上移动光标: `0` `^` `$` `f` `F` `t` `T` `,` `;`
...
##### <a name="t8"></a>区域选择 `&lt;action&gt;a&lt;object&gt;` 或 `&lt;action&gt;i&lt;object&gt;`
...
##### <a name="t13"></a>分屏: `:split` 和 `vsplit`.
